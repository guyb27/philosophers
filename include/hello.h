...
void							gui_print_philo(t_philo *philo,\
												t_philo_heart *philo_heart);
void							gui_time_to_dance(char *s,\
									clock_t last_frame_time, sfEvent event);

/*
**	visu_utils.c
*/
void							gui_print_str(float x, float y,\
														int size, char *str);
void							gui_print_rect(sfVector2f pos,\
											sfVector2f size, sfColor color);
void							gui_print_picture(sfVector2f pos,\
										sfVector2f scale, char *image_path);
void							gui_print_loadbar(sfVector2f pos,\
											sfVector2f size, int percent);
